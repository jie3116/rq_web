...
def _normalize_image_url(value):
    ...
    # Allow static absolute path generated by app and root-relative media path.
    if raw.startswith("/"):
        return raw
    ...
    # Convert common Google Drive share URLs to a direct image URL.
    ...
    # User often pastes domain/path without scheme.
